...
static const FieldInfo gGlobalPrefsFields[] = {
    {(size_t)-1, SettingType::Comment,
     (intptr_t) "For documentation, see https://www.sumatrapdfreader.org/settings/settings3-4-7.html"},
    ...
    {offsetof(GlobalPrefs, defaultZoom), SettingType::String, (intptr_t) "fit width"},
    ...
    {offsetof(GlobalPrefs, fullPathInTitle), SettingType::Bool, true},
    {offsetof(GlobalPrefs, showMenubar), SettingType::Bool, true},
    {offsetof(GlobalPrefs, showToolbar), SettingType::Bool, false},
    ...
    {offsetof(GlobalPrefs, showStartPage), SettingType::Bool, false},
    {offsetof(GlobalPrefs, checkForUpdates), SettingType::Bool, false},
